...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Task task1 = new Task(Types.TASK, "1 Наименование простой задачи 1", "1 Описание простой задачи 1", TaskStatus.NEW, LocalDateTime.now(), 0L);
        ...
        */
        ...
        taskManager.updateTask(new Task(Types.TASK, "Обновили Наименования Задачи 2", "Обновили Описание Задачи 2", TaskStatus.DONE, LocalDateTime.now(), 0L));
